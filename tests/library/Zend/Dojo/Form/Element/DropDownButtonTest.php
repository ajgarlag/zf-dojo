...
// Call Zend_Dojo_Form_Element_DropDownButtonTest::main() if this source file is executed directly.
if (!defined("PHPUnit_MAIN_METHOD")) {
    define("PHPUnit_MAIN_METHOD", "Zend_Dojo_Form_Element_DropDownButtonTest::main");
}

require_once dirname(__FILE__) . '/../../../../TestHelper.php';

/** Zend_Dojo_Form_Element_DropDownButton */
require_once 'Zend/Dojo/Form/Element/DropDownButton.php';
...
/**
 * Test class for Zend_Dojo_Form_Element_DropDownButton.
 *
 * @category   Zend
 * @package    Zend_Dojo
 * @subpackage UnitTests
 ...
 */
class Zend_Dojo_Form_Element_DropDownButtonTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $suite  = new PHPUnit_Framework_TestSuite("Zend_Dojo_Form_Element_DropDownButtonTest");
    ...
    {
        $element = new Zend_Dojo_Form_Element_DropDownButton('foo');
        return $element;
    }
    ...
    {
        $button = new Zend_Dojo_Form_Element_DropDownButton('foo');
    ...
    {
        $button = new Zend_Dojo_Form_Element_DropDownButton('foo', 'Label');
    ...
    public function testShouldRenderDropDownButtonDijit()
    {
        $html = $this->element->render();
        $this->assertContains('dojoType="dijit.form.DropDownButton"', $html);
    }
    ...
    {
        $this->element->setLabel('DropDownButton Label')
                      ->setView($this->getView());
        $html = $this->element->render();
        $this->assertContains('DropDownButton Label', $html, $html);
        $this->assertNotContains('value="', $html);
    }
}

// Call Zend_Dojo_Form_Element_DropDownButtonTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == "Zend_Dojo_Form_Element_DropDownButtonTest::main") {
    Zend_Dojo_Form_Element_DropDownButtonTest::main();
}

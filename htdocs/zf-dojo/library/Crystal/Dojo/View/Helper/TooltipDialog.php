 ...
 * @version    $Id: TooltipDialog.php 7 2010-04-09 22:54:41Z merizamed $
 */
...
class Crystal_Dojo_View_Helper_TooltipDialog extends Zend_Dojo_View_Helper_DijitContainer
{
     ...
     * @var string
     */
    protected $_dijit  = 'dijit.TooltipDialog';

    /**
     * Dojo module to use
     * @var string
     */
    protected $_module = 'dijit.TooltipDialog';
     ...
     * @return string
     */
    public function tooltipDialog($id = null, $content = '', array $params = array(), array $attribs = array())
    {
        if (0 === func_num_args()) {
            return $this;
        }
